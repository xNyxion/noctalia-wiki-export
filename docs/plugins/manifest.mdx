...
See [IPC Guide](/plugins/ipc/) for details.
...
See [Bar Widget Guide](/plugins/bar-widget/) for details.
...
See [Panel Guide](/plugins/panel/) for details.
...
See [Settings Guide](/plugins/settings/) for details.
...
- [Bar Widget Guide](/plugins/bar-widget/) - Develop bar widgets
- [Panel Guide](/plugins/panel/) - Create overlay panels
