...
- [Bar Widget Development](/plugins/bar-widget/) - Advanced bar widget features
- [Plugin API Reference](/plugins/api/) - Complete API documentation
- [Manifest Reference](/plugins/manifest/) - Full manifest documentation

- [IPC Guide](/plugins/ipc/) - Respond to external commands
- [Settings UI](/plugins/settings-ui/) - Let users configure your plugin
- [Translations](/plugins/translations/) - Support multiple languages
