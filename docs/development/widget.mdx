...
:::note
At this point, we recommend contributing **plugins** rather than core widgets. Plugins are easier to distribute, maintain independently, and don't require changes to the main codebase. See the [Plugins Overview](/plugins/overview/) for details on creating and sharing plugins.
:::
