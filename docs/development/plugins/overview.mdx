...
4. **[Panel Development](/development/plugins/panel/)** - Create overlay panels
   - Build full-screen interfaces
   - Handle panel lifecycle
   - Create complex UIs

5. **[Plugin API Reference](/development/plugins/api/)** - Master the API
   - Complete API documentation
   - Service integration
   - Advanced patterns

6. **[IPC Guide](/development/plugins/ipc/)** - Background processing
   - Create IPC handlers
