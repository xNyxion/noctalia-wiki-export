...
:::tip[Quick Start]
New to plugin development? Jump straight to the [Getting Started guide](/development/plugins/getting-started/) to create your first plugin in minutes!
:::
...
**Learn more:** [Bar Widget Development](/development/plugins/bar-widget/)
...
**Learn more:** [Desktop Widget Development](/development/plugins/desktop-widget/)
...
**Learn more:** [Control Center Widget Development](/development/plugins/control-center-widget/)
...
**Learn more:** [Launcher Provider Development](/development/plugins/launcher-provider/)
...
**Learn more:** [Panel Development](/development/plugins/panel/)
...
**Learn more:** [IPC Guide](/development/plugins/ipc/)
...
**Learn more:** [Settings UI Guide](/development/plugins/settings-ui/) *(coming soon)*
...
For complete API documentation, see the [Plugin API Reference](/development/plugins/api/).
:::
...
1. **[Getting Started](/development/plugins/getting-started/)** - Create your first plugin
   - Set up your development environment
   - Create a basic bar widget
   - Understand the plugin structure

2. **[Manifest Reference](/development/plugins/manifest/)** - Understand plugin configuration
   - Learn all manifest fields
   - Configure entry points
   - Set up default settings

3. **[Bar Widget Development](/development/plugins/bar-widget/)** - Build bar widgets
   - Create interactive widgets
   - Handle user interactions
   - Style with Noctalia's design system

4. **[Desktop Widget Development](/development/plugins/desktop-widget/)** - Create desktop widgets
   - Draggable, scalable widgets
   - At-a-glance information displays

5. **[Control Center Widget](/development/plugins/control-center-widget/)** - Add control center buttons
   - Quick action buttons
   - Panel toggle buttons

6. **[Launcher Provider](/development/plugins/launcher-provider/)** - Extend the launcher
   - Custom search sources
   - Command handlers
   - Category-based browsing

7. **[Panel Development](/development/plugins/panel/)** - Create overlay panels
   - Build full-screen interfaces
   - Handle panel lifecycle
   - Create complex UIs

8. **[Plugin API Reference](/development/plugins/api/)** - Master the API
   - Complete API documentation
   - Service integration
   - Advanced patterns

9. **[IPC Guide](/development/plugins/ipc/)** - Background processing
   - Create IPC handlers
   - Handle external commands
   - Integrate with scripts and keybindings

10. **Additional Topics**
    - [Settings UI](/development/plugins/settings-ui/) - Configuration interfaces
    - [Translations](/development/plugins/translations/) - Internationalization
...
Ready to start building? Head to the [Getting Started guide](/development/plugins/getting-started/) to create your first plugin in just a few minutes!
