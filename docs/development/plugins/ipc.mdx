...
// Open/close panels - use withCurrentScreen for proper screen selection
...
:::tip
The `withCurrentScreen` helper is the preferred way to get a screen reference in IPC handlers. It automatically selects the appropriate screen based on cursor position.
:::
...
- [Main Component](/development/plugins/overview/#main-component) - Overview of Main.qml
