...
- [Add a Panel](/development/plugins/panel/) - Create an overlay panel
- [Bar Widget Development](/development/plugins/bar-widget/) - Advanced bar widget features
- [Plugin API Reference](/development/plugins/api/) - Complete API documentation
- [Manifest Reference](/development/plugins/manifest/) - Full manifest documentation

- [IPC Guide](/development/plugins/ipc/) - Respond to external commands
- [Settings UI](/development/plugins/settings-ui/) - Let users configure your plugin
- [Translations](/development/plugins/translations/) - Support multiple languages
...
Start Noctalia with the `NOCTALIA_DEBUG` environment variable:

```bash
NOCTALIA_DEBUG=1 qs -c noctalia-shell
```

Or if using systemd, create an override:
...
:::caution
Hot reload is for development only. Don't run with `NOCTALIA_DEBUG=1` in production as it adds overhead from file watching.
:::
...
- [Manifest Reference](/development/plugins/manifest/) - Complete manifest documentation
- [Bar Widgets](/development/plugins/bar-widget/) - Advanced bar widget features
