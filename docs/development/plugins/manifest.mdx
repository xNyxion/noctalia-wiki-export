...
### `desktopWidget`
- **File**: DesktopWidget.qml
- **Purpose**: Draggable widget on the desktop background
- **Use cases**:
  - Display at-a-glance information
  - Clock, weather, or media displays
  - Audio visualizers
  - Decorative elements
...
See [Desktop Widget Guide](/development/plugins/desktop-widget/) for details.

### `controlCenterWidget`
- **File**: ControlCenterWidget.qml
- **Purpose**: Button widget in the Control Center panel
- **Use cases**:
...
See [Control Center Widget Guide](/development/plugins/control-center-widget/) for details.

### `launcherProvider`
- **File**: LauncherProvider.qml
- **Purpose**: Search/browse provider for the launcher
- **Use cases**:
  - Custom search sources
  - Command handlers (e.g., `>kaomoji`)
...
See [Launcher Provider Guide](/development/plugins/launcher-provider/) for details.
