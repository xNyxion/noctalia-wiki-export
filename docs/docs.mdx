...
3. Explore [Configuration](/configuration/general/) to customize your setup

**Already installed?** Jump straight to [Configuration](/configuration/general/) to personalize your shell.
