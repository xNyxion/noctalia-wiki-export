...
You can setup systemd service via NixOS module or Home Manager module. If you [configure Noctalia shell with home-manager](#config-with-home-manager), then Home Manager module is a better choice.
