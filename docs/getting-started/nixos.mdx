...
You can configure plugins in a declarative way. If an enabled plugin isn’t installed in the plugin directory, Noctalia will automatically install it when it starts up.
...
Then override the Noctalia package:
```nix
