...
:::caution[Last Resort]
You can start noctalia-shell with a special environment variable, but this is **not recommended** on multi-monitor setups as it will likely break tooltips and other contextual menu positioning on monitors that don't have a (0,0) origin.
...
<details>
<summary><strong>Why won't some applications appear in the launcher?</strong></summary>
...
<details>
<summary><strong>Why won't my screen recorder start recording?</strong></summary>

Common causes:

1. **Missing package**: Make sure you have installed the proper package or flatpak
...
<details>
<summary><strong>Why are my tray icons missing after (re)starting Noctalia?</strong></summary>
...
<details>
<summary><strong>Why does my clipboard history preview look weird?</strong></summary>
**How to fix:**
